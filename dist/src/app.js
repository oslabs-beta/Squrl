...
const App = () => {
    ...
    const [tableStateData, setTableStateData] = react_1.useState({ 'test1': [
            {
                columnName: 'test',
                category: 'test',
                subcategory: 'test',
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(react_router_dom_1.BrowserRouter, null,
            ...
            react_1.default.createElement(react_router_dom_1.Switch, null,
                ...
                react_1.default.createElement(react_router_dom_1.Route, { path: '/DataGeneration', component: () => (react_1.default.createElement(DataGeneration_1.default, { tableStateData: tableStateData, setTableStateData: setTableStateData })) }),
